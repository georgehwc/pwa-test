...
function printPriceTable(arrayPrice, min, max) {
  ...
  for (i = min; i <= max; i++) {
    ...
    <th>
    <button type="button" class="btn-eatPrice" value="${i}"> ${arrayPrice[i]
      }</button>
     
    </th>
    <th>
    <button type="button" class="btn-eatPrice"  value="${i}"> ${arrayPrice[i] / 2
      }</button>
    </th>
  </tr>`
  }
...
async function getData() {
  ...
  firebase
    ...
    .then(() => {
      ...
      if (jackpot == '') {
        document.getElementById('head-jackpot').innerHTML = '<del>jackpot</del>'
      } else {
...
document.getElementById('eat-confirm').addEventListener('click', (e) => {
  ...
  if (
    ...
    document.getElementById('confirm-1').style.opacity = 1
    document.getElementById('confirm-2').disabled = false
    document.getElementById('confirm-2').style.opacity = 1
    document.getElementById('confirm-3').disabled = false
    document.getElementById('confirm-3').style.opacity = 1
    document.getElementById('confirm-4').disabled = false
    document.getElementById('confirm-4').style.opacity = 1
